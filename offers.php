...
<body>
 <div class="content" onload="openTabs1();">
                    <div class="card no-mb">
                        ...
                        <a class="nav-item nav-link" id="start-tab-offers" data-toggle="tab" href="#" role="tab" aria-controls="custom-nav-start" aria-selected="false" onclick="openTabs2();">ПОДКЛЮЧЕННЫЕ</a>
                        <a class="nav-item nav-link" id="oss-tab-offers" data-toggle="tab" href="#" role="tab" aria-controls="custom-nav-oss" aria-selected="false" onclick="openTabs3();">СМАРТЛИНКИ</a>
                                                            ...
                                                            <div class="jss8">
                                                                <div class=" css-2b097c-container">
                                                                    <div class="MuiFormControl-root MuiTextField-root MuiFormControl-fullWidth">
                                                                        <label class="MuiFormLabel-root MuiInputLabel-root MuiInputLabel-formControl MuiInputLabel-animated MuiInputLabel-shrink" data-shrink="true" for="react-select-multiple">Тип оффера</label>
                                                        ...
                                                        <table class="table simple-table align-left no-wrap table-sm" id="table-offers">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>Video</td>
                                                                    <td class="td-operator"><img src="images/apk.png" alt=""></td>
                                                                    <td>Россия</td>
                                                                    <td><span>3.83</span>
                                                    ...
                                                    <table class="table simple-table align-left no-wrap table-sm" id="table-offers">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>Адалт</td>
                                                                <td class="td-operator inline"><img src="images/apk.png" alt=""></td>
                                                                <td>Россия</td>
                                                                <td>3</td>
