...
<h1 id="subscr-name" style="text-align: center; font-size: 18px; line-height: 1.2;"><img src="img/st.png" alt="" style="width: 100px;"><br>
	...
	<form id="subscr-form" >
            <div id="activation-code-container" style="text-align: center;">
                <div style="font-size: 18px;">ПОПРОБУЙТЕ</div>
            	<div style="font-size: 16px;">1 СУТКИ БЕСПЛАТНО</div>
                <label for="ActivationCode">Получите код в SMS:</label>
                <div style="margin-top: 5px;"><div id="time" style="font-size: 22px;"></div></div>
            </div>
        <div id="submit-container" style="margin-top: 15px;">
            <div>
                    <input id="ButtonSubmit" type="button" value="Получить код по SMS" onclick="link();" style="width: 100%;">
