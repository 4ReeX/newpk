   ...
   <div class="footer-inner bg-offer">
      <div class="row">
         ...
         <div class="line2">
            ...
            <button type="button" class="btn btn-outline-warning create-links" onclick="link1();">Создать ссылки</button>
         </div>
      </div>
</footer>
<div class="alert-copy" style="display: none;" id="alertCopy"><i class="fa fa-code"></i><span>Ссылка скопирована</span></div>
</div>